...
const RosItem = ({
  ...
  <View style={styles.rosBlock}>
    ...
    <View
      style={{ borderTopWidth: 1, borderTopColor: "#e2e8f0", paddingTop: 12 }}
    >
...
export default function HastaAnamnezMiniApp() {
  ...
  const exportPDF = async () => {
    if (!formData.patientId) {
      Alert.alert(
        "Hata",
        "Öncelikle dışa aktarmak istediğiniz hastayı kaydedin."
      );
      return;
    }
    ...
    if (filesToExport.length === 0) {
      Alert.alert(
        "Hata",
        "Seçilen aralıkta bu hastaya ait kaydedilmiş dosya bulunamadı."
      );
      return;
    }
    ...
    filesToExport.forEach((f, index) => {
      ...
      const headerAndFooter = (data: any) => {
        ...
        doc.setFontSize(9);
        doc.text(normalizeText("HACETTEPE UNIVERSITESI HASTANELERI"), 14, 15);
        doc.setFontSize(9);
    ...
    try {
      ...
      const fileName = `Dosya_${normalizeText(
            ...
            {Object.keys(groupedPatients).length === 0 ? (
              ...
              <View>
                {Object.entries(groupedPatients).map(
                  ([pId, records]: [string, FormData[]]) => {
                    const latestRecord = records[0];
                    const displayName =
                      latestRecord.kimlik_adSoyad || "İsimsiz";
                          ...
                          >
                            {records.map((record) => {
                              ...
                              return (
                                <TouchableOpacity
                                  key={record.id}
                                  onPress={() => loadFile(record)}
                                  style={[
                                    styles.recordItem,
                                    isActive
                                      ? styles.recordItemActive
                                      : styles.recordItemInactive,
                                  ]}
                                >
                                  <View style={{ flex: 1 }}>
                                    <View
      ...
      <View style={{ flex: 1 }}>
        ...
        <View style={styles.topBar}>
          ...
          <View style={styles.tabWrapper}>
            <TouchableOpacity
              onPress={() => setActiveTab("pediatri")}
              style={[
                styles.tabBtn,
                activeTab === "pediatri" && styles.tabBtnActive,
              ]}
            >
              <Text
                style={[
                  styles.tabBtnText,
                  activeTab === "pediatri" && styles.tabBtnTextActive,
                ]}
              >
                Genel Pediatri
              </Text>
            ...
            <TouchableOpacity
              onPress={() => setActiveTab("romatoloji")}
              style={[
                styles.tabBtn,
                activeTab === "romatoloji" && styles.tabBtnActive,
              ]}
            >
              <Text
                style={[
                  styles.tabBtnText,
                  activeTab === "romatoloji" && styles.tabBtnTextActive,
                ]}
              >
                Romatoloji
              </Text>
            ...
            {activeTab === "pediatri" && (
              <View>
                ...
                <View style={styles.innerCard}>
                  ...
                  <RosItem
                    systemName="Genel"
                    symptoms="Ateş, kilo kaybı, halsizlik vb."
                  ...
                  <RosItem
                    ...
                    symptoms="Baş ağrısı, görme sorunları vb."
                  ...
                  <RosItem
                    ...
                    symptoms="Çarpıntı, göğüs ağrısı vb."
                  ...
                  <RosItem
                    ...
                    symptoms="Eklem ağrısı, nöbet vb."
              ...
              <View>
                ...
                <View style={styles.innerCard}>
                  ...
                  <RadioGroup
                    ...
                    options={[
                      { label: "Aniden", value: "Aniden" },
                      { label: "Sinsi", value: "Sinsi" },
                    ]}
                    onChange={handleRadioChange}
                  />
                  <RadioGroup
                    label="Bel ağrısı şikayeti var mı?"
                    name="rom_belAgrisi"
                  ...
                  />
                  <TextAreaGroup
                    label="Semptom öncesi enfeksiyon?"
                ...
                <View style={styles.innerCard}>
                  ...
                  />
                  <YesNoDetail
                    label="Ailede periyodik ateş (FMF)?"
          ...
          <View style={styles.modalContent}>
            ...
            <TouchableOpacity
              onPress={() =>
                setExportRange({
                  ...exportRange,
                  includeAll: !exportRange.includeAll,
                })
              }
            ...
            >
              <View
                style={[
                  styles.checkbox,
                  {
                    backgroundColor: exportRange.includeAll
                      ? "#4f46e5"
                      : "transparent",
                    borderColor: exportRange.includeAll ? "#4f46e5" : "#94a3b8",
                  },
                ]}
              />
              <Text style={{ color: "#334155", fontWeight: "500" }}>
                Birden fazla kaydı birleştir
              </Text>
            </TouchableOpacity>
            ...
            {exportRange.includeAll && (
              ...
              >
                ...
                >
                  Tarih aralığı (boş bırakılırsa hepsi):
                </Text>
                <View style={{ gap: 12 }}>
                  <View>
                    <Text
                    ...
                    <TextInput
                      style={styles.inputField}
                      onChangeText={(text) =>
                        setExportRange({ ...exportRange, start: text })
                      }
                  ...
                  <View>
                    ...
                    <TextInput
                      style={styles.inputField}
                      onChangeText={(text) =>
                        setExportRange({ ...exportRange, end: text })
                      }
